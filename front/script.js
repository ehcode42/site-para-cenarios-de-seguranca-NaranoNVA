    ...
    if(data.peoples !== undefined){
      data.peoples.forEach(people => {
        ...
        <tr id="${people.Id}">
          ...
          <td>${people.Salary}</td>
          <td>
            <a href="#pnlUpdate" onclick="openUpdate(${people.Id});" class="text-light material-icons">edit</a>
            <a href="#pnlListPipous" onclick="deletePipou(${people.Id});" class="text-light material-icons">delete</a>
          </td>
        </tr>
        `);
      });
